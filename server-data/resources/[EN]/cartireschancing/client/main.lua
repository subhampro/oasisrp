...
AddEventHandler('gln_oponazapasowa:uzyj', function()
	ESX.ShowHelpNotification('~r~ Get closer to the damaged wheel!')
	animacja()
end)
		...
		if DoesEntityExist(vehicle) then
			...
			TriggerServerEvent('gln_oponazapasowa:usunOpone')
				...
				Citizen.CreateThread(function()
					...
					TriggerEvent("pNotify:SendNotification", {text = "You are changing the tire!", type = "info", timeout = 5000, layout = "centerLeft"})
					...
					if CurrentAction ~= nil then
						...
						if closestTire ~= nil then
							...
							TriggerEvent("pNotify:SendNotification", {text = "You have finished replacing the tire!", type = "success", timeout = 2000, layout = "centerLeft"})
						end
					end
