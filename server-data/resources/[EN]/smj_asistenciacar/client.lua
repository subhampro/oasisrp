...
function GetTargetVehicle(player, dir)
    ...
    if DoesEntityExist(dmgVeh) then
        ...
        ShowNotification("You must be near the vehicle to request roadside assistance.")       --- Aracın yanında değilse giden mesaj ----
    end
end
...
AddEventHandler('pagarmecano:success', function (price)
	...
	ShowNotification("Vous avez payé le prix à l'avance!~r~-$" .. price .. "~s~.Un Mechanic viendra sous peu!")
end)
