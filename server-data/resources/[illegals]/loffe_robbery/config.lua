...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {100, 3000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 60, second = 0}, robbed = false},
    {coords = vector3(-705.73, -914.91, 19.22-0.98), heading = 91.0, money = {100, 3000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 60, second = 0}, robbed = false}
