...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -223.83, y = -1320.35, z = 30.89 },
	...
	--[[Garage = {
		Pos   = { x = -208.51, y = -1342.26, z = 30.89 },
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 0, g = 0, b = 0 },
		Type  = 21
	},]]--
	...
	--[[Craft = {
		Pos   = { x = -227.83, y = -1327.78, z = 30.89 },
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 0, g = 0, b = 0 },
		Type  = 21
	},]]--
	...
	VehicleSpawnPoint = {
		Pos   = { x = -182.56, y =-1286.51, z = 31.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -159.69, y = -1305.76, z = 30.35 },
