...
Config.DeliveryPoints = {
	vector3(3333.02,5160.63,17.33),
}

-- Gold Job Delivery Marker Setting:
Config.DeliveryDrawDistance  = 5.0
...
Config.ItemMaxAmount1 = 2.5					-- set maximum reward amount of item1 (this value is multiplied with x100)
...
Config.ItemMaxAmount2 = 2					-- set maximum reward amount of item2
...
Config.GoldExchange = {
	{ ["x"] = 1240.37, ["y"] = -3052.67, ["z"] = 14.30, ["h"] = 0 },
}
