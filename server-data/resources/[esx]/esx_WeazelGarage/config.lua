...
Config.PoliceDatabaseName = 'reporter'	-- set the exact name from your jobs database for police

--Police Car Garage:
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = -560.86,  y = -901.09, z = 24.02},
		}
	}
}
...
Config.BoatDraw3DText = "Press ~g~[E]~s~ for ~y~EMS Boat Garage~s~"		-- set your desired text here
...
Config.PoliceVehicles = {
	{ model = 'newsvan', label = 'Weazel News Van', price = 0 },
		
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'newsheli', label = 'Weazel heli', livery = 0, price = 0 },
	{ model = 'newsheli2', label = 'Weazel heli 2', livery = 0, price = 0 }
}
...
Config.CarOutFromPolGar = "You took out a ~b~Vehicle~s~ from ~y~EMS Garage~s~!"
Config.HeliOutFromPolGar = "You took out a ~b~Helicopter~s~ from ~y~EMS Heli Garage~s~!"
Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~EMS Boat Garage~s~!"
