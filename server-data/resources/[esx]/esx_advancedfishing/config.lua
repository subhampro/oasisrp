Config = {}
	...
	Config.FishPrice = {a = 800, b = 1000} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 5000, b = 8000} --Will get dirty money
	Config.SharkPrice = {a = 8000, b = 10000} --Will get dirty money
