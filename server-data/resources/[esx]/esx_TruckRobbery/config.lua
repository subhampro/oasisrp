...
Config.ItemMinAmount1 = 100					-- set minimum reward amount of item1
Config.ItemMaxAmount1 = 500					-- set maximum reward amount of item1
Config.EnableRareItemReward = true			-- add another item as reward but this has only 25% chance 
Config.ItemName2 = "drugItem"				-- exact name of your item2
Config.ItemMinAmount2 = 1					-- set minimum reward amount of item2
Config.ItemMaxAmount2 = 1					-- set maximum reward amount of item2
Config.RandomChance = 10						-- Set chance, 1/2 is default, which is 50% chance. If u e.g. change value to 4, then 1/4 equals 25% chance.
