...
Config.MinPolice                 = 2        -- Min number of police needed to rob jewelry store.
...
Config.AllowedWeapons = {
   { name = 'WEAPON_PISTOL', chance = 40 },
   { name = 'WEAPON_BAT', chance = 50 },
   { name = 'WEAPON_CROWBAR', chance = 100 },
}
...
Config.ItemDrops  = {
   { name = 'goldbar', max = 1,  chance = 25 },
   { name = 'goldwatch', max = 100, chance = 100 },
}
