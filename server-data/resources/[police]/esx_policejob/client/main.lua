...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		if data.current.value == 'citizen_interaction' then
			...
			if PlayerData.job and PlayerData.job.name == 'police' and PlayerData.job.grade_name == 'sergeant' or PlayerData.job.grade_name == 'lieutenant' or PlayerData.job.grade_name == 'boss' then
