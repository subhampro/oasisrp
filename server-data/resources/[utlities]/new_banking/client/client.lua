...
local banks = {
	...
	{name="Bank", id=108, x=149.98, y=-1040.47, z=29.37},
...
local atms = {
	{name="ATM", id=108, x=-197.57, y=-1309.43, z=31.29},
	{name="ATM", id=108, x=315.14, y=-593.73, z=43.28},
	{name="ATM", id=108, x=-38.177, y=-1115.5, z=26.43},
	{name="ATM", id=108, x=114.4, y=-776.4, z=31.42},
	...
	{name="ATM", id=277, x=111.25, y=-775.24, z=31.427},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Press [E] to access Account ~ b ~")
