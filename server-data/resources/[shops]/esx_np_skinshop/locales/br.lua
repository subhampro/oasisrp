Locales['br'] = {
  ...
  ['buy'] = 'Buy Clothes',
  ['no_outfit'] = 'You do not own any Outfit',
  ['saved_outfits'] = 'Saved Outfits',
  ['change_clothe'] = "Change Clothes",
  ['del_clothe'] = "Remove Clothes",
  ['choose_clothe'] = 'What outfit do you want to use?',
  ['which_delete'] = 'What outfit do you want to remove?',
  ['clothe_delete'] = 'Outfit Removed',
}